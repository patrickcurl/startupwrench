...
class Job extends BaseModel implements SluggableInterface
{
	use SluggableTrait;
    //
	protected $sluggable = [
...
public static function getJobs($keyword = "", $location="", $sortBy="relevance", $radius='100'){
  $client = new Indeed([
    'publisher' => '6809593849661121',
    'v' => 2,
    'highlight' => 0,
    ]);
